...
class Ui_AppWindow(object):
    def setupUi(self, AppWindow):
        ...
        self.actionConfirm_Regions = QAction(AppWindow)
        self.actionConfirm_Regions.setObjectName(u"actionConfirm_Regions")
        self.actionConfirm_Regions.setMenuRole(QAction.MenuRole.NoRole)
...
"}")
    ...
    def retranslateUi(self, AppWindow):
        ...
        self.actionConfirm_Regions.setText(QCoreApplication.translate("AppWindow", u"Confirm Regions", None))
#if QT_CONFIG(shortcut)
        self.actionConfirm_Regions.setShortcut(QCoreApplication.translate("AppWindow", u"C", None))
#endif // QT_CONFIG(shortcut)
